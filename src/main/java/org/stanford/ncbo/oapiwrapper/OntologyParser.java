...
public class OntologyParser {
	...
	private void addOntologyIRI(OWLDataFactory fact, OWLOntology sourceOnt) {
        ...
        /**
         * The method that build the OWL ontology. We added the masterOntology
         * to be able to retrieve the ontology IRI
	...
	private void generateGroundTriplesForAxioms(Set<OWLAxiom> allAxioms,
        ...
        /**
         * Call internal parse to parse the ontology. Parses one or more ontology files.
         * @return
         * @throws Exception 
         */
	...
	private boolean internalParse() {
		...
		if (!buildOWLOntology(ontology)) return false;
