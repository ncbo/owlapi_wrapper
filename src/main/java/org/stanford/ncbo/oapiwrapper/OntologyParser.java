...
public class OntologyParser {
  ...
  /**
   * Determines the list of ontologies to parse, and sets the obo version if
   * applicable.
   */
  ...
  /**
   * The method that build the OWL ontology. We added the masterOntology to be
   * able to retrieve the ontology IRI
   *
   * @param masterOntology
   * @return
   */
  private boolean buildOWLOntology(OWLOntology masterOntology) {
    ...
    try {
      ...
      addOntologyIRI(sourceOwlManager.getOWLDataFactory(), masterOntology);
  ...
  /**
   * Call internal parse to parse the ontology. Parses one or more ontology
   * files.
   *
   * @return
   * @throws Exception
  ...
  /**
   * Find the main file defining the ontology (mainly useful when a zip file is
   * uploaded)
   *
